  ...
  <header class="bg-2_color py-8 shadow-2xl">
    <div class="container mx-auto md:flex justify-between items-center">
      ...
      <div class="md:flex md:justify-end md:items-center">
        <ul
          class="md:flex md:px-0 px-10 md:pb-0 pb-10 md:static absolute bg-gradient-to-t from-1_color from-60% to-2_color md:bg-gradient-to-t from-2_color from-60% to-2_color md:w-auto w-full top-20 duration-700 ease-in"
        ...
        >
          ...
          >
            <button
              ...
              class="select-none text-white font-mono text-xl hover: hover:rounded-lg px-4 py-1 hover:-translate-y-1 transition-all duration-300 select-none"
            >
              {{ link.name }}
            </button>
          </li>
