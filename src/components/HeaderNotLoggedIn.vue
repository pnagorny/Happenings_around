...
<div class="container mx-auto md:flex justify-between items-center">
  <div class="w-full text-lg font-extrabold md:w-fit md:text-left">
    <button @click="MenuOpen()" class="md:hidden text-white">
        <svg class="ml-4 w-8 h-8 " fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
      </button>
      <span class="text-violet-500 text-3xl ml-6 md:ml-0">Happenings</span>
      <span class="text-white text-3xl">Around</span>
