...
<template>
    <div>
        ...
        <form @submit.prevent="Register">
            ...
            <input type="file" id="file_input" @change="handleFileChange" class="block w-full text-sm text-slate-500
                ...
                mb-4
            "/>
            <input type="submit" value="Zarjestruj się" class="bg-purple-500 text-white ml-20 py-2 px-6 rounded-md hover:bg-purple-600 ">
